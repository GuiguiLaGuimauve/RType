...
// Last update Mon Jan  2 21:47:38 2017 Lecoq Maxime
//
...
CoreClient::CoreClient()
{
  ...
  _packetPtr[IPacket::PacketType::GAMEDATA] = &CoreClient::gameData;
...
bool		CoreClient::gameData(const IPacket *pa, IUserNetwork *u)
{
